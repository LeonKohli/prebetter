...
export const useAlertTableColumns = () => {
  ...
  const compactGroupedColumns: ColumnDef<CompactGroupedAlert>[] = [
    {
      ...
      header: ({ column }) => h(DataTableColumnHeader, { column, title: 'Alerts' }),
      cell: ({ row }) => {
    ...
    {
      accessorKey: 'alerts',
      header: ({ column }) => h(DataTableColumnHeader, { column, title: 'Classifications' }),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: ({ column }) => h(DataTableColumnHeader, { column, title: 'Last Detected' }),
      cell: ({ row }) => {
  ...
  const groupedColumns: ColumnDef<FlattenedGroupedAlert>[] = [
    {
      accessorKey: 'count',
      header: ({ column }) => h(DataTableColumnHeader, { column, title: 'Count' }),
      cell: ({ row }) => {
